...
class BalanceControllerTest {
    ...
    void setUp() {
        ...
        productServiceProxy = Mockito.mock(ProductServiceProxy.class);
        balanceController = new BalanceController(balanceService, productServiceProxy);
    }
    ...
    void getAvailableItems_filterByLocationAndDept() {
        ...
        Mockito.verify(balanceService).getAvailableItemsByLocationAndDept(1, productServiceProxy.getProductsByDept(1));
        assertEquals(expected, actual);
    }
    ...
    void getAvailableItems_filterByDept() {
        ...
        Mockito.verify(productServiceProxy).getProductsByDept(1);
        Mockito.verify(balanceService).getAvailableItemsByDept(productServiceProxy.getProductsByDept(1));
        assertEquals(expected, actual);
    }
}